...
![window: a 40-minute congestion event — smoke spreads, bursts marked ◆](docs/hero1.png)
![window: a 40-minute congestion event — smoke spreads, bursts marked ◆](docs/hero2.png)
![window: a 40-minute congestion event — smoke spreads, bursts marked ◆](docs/hero3.png)
